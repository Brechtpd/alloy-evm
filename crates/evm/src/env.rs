...
impl<Spec> EvmEnv<Spec> {
    ...
    pub fn with_block_number(mut self, number: U256) -> Self {
        // Use chain_id from cfg_env as default
    ...
    /// Sets the block number if provided for the default chain.
    ...
    /// Sets the block timestamp if provided for the default chain.
...
impl<Spec> core::fmt::Debug for EvmEnv<Spec> {
